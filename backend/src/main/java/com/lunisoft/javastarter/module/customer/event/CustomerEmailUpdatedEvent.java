...
/**
 * Published when a customer's email address is updated. Listeners can react to apply side effects
 * (e.g. auto-detecting country code) within the same transaction.
 */
