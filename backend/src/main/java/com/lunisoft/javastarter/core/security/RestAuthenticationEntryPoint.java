 ...
 * DispatcherServlet} (e.g. {@code .anyRequest().authenticated()} rejecting a request with
 * no/invalid JWT). Because these failures never reach a controller, {@code @RestControllerAdvice}
