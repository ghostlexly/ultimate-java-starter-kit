package com.lunisoft.ultimatejavastarterkit.core.pdf;

import com.lunisoft.ultimatejavastarterkit.config.PdfProperties;
...
public class PdfService {
     ...
     *
     * @param templateName the template file name without extension (e.g. "invoice"),
     *                     resolved from resources/templates/{templateName}.html
    ...
    /**
     * Converts an HTML string to a PDF using Playwright's headless Chromium.
     * Waits for Tailwind CSS CDN to finish rendering before generating the PDF.
     */
    ...
    /**
     * Converts a classpath resource (e.g. "static/avatar.png") to a base64 data URI
     * that can be used as an img src in HTML templates rendered by Playwright.
     *
